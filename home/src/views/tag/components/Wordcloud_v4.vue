    ...
    svg.append('g')
        ...
        .on('mouseover', function (event, d) {
          ...
          const glow = svg.append('circle')
              ...
              .attr('r', 0)  // 初始半径为0
              .style('fill', 'none')
              .style('stroke', '#ffffff')  // 白色光芒
              .style('stroke-width', 6)  // 较宽的光芒
              .style('stroke-opacity', 0.9)  // 较高的透明度
              .transition()
              .duration(500)  // 延长过渡时间，让光芒扩展得更慢
              .attr('r', d.size * 2)  // 扩大光芒的半径，使其更明显
              .style('stroke-opacity', 0.4);  // 逐渐减小透明度
